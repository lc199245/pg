...
const columns = [
  ...
  },
  {
    title: (
      <FormattedMessage
        id="dashboardandanalysis.table.sendout-keyword"
        defaultMessage="Send-out keyword"
      />
    ),
    dataIndex: 'keyword',
    key: 'keyword',
...
const TopSearch = ({ loading, visitData2, searchData, dropdownGroup }) => (
  <Card
    ...
    title={
      <FormattedMessage
        id="dashboardandanalysis.analysis.top-sendouts"
        defaultMessage="Top Send-outs"
      />
    }
    extra={dropdownGroup}
    style={{
      ...
      >
        <NumberInfo
          subTitle={
            <span>
              <FormattedMessage
                id="dashboardandanalysis.analysis.send-users"
                defaultMessage="send users"
              />
              <Tooltip
                title={
                  <FormattedMessage
      ...
      >
        <NumberInfo
          subTitle={
            <span>
              <FormattedMessage
                id="dashboardandanalysis.analysis.per-capita-sendouts"
                defaultMessage="Per Capita Send-outs"
              />
              <Tooltip
                title={
                  <FormattedMessage
